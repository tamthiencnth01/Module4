...
<body>
	<form:form id="formUploadFile" method="POST" action="uploadFile" enctype="multipart/form-data" modelAttribute="myFile">
		<input type="number" name="${customer.id}" placeholder="input id">
		<input type="text" name="${customer.name}" placeholder="input name">
		<input type="text" name="${customer.address}" placeholder="input address">
